          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
              ...
              <p className="text-lg text-gray-700 mb-12 leading-relaxed">
                We're here to help you with all your accounting needs. Reach out to us and let's discuss how we can support your business growth.
              </p>
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">info@fineraglobal.com</p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">123, Finera Business Park</p>
                    <p className="text-gray-700">Main Road, Mumbai, India</p>
                  </div>
                </div>
              </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      disabled={isSubmitting}
                      rows={5}
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200 resize-vertical disabled:bg-gray-100"
                      placeholder="Tell us about your accounting needs or any questions you have..."
                    ></textarea>
                  </div>
                  ...
                  <div>
                    <button
                      type="submit"
                      disabled={isSubmitting}
                      className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white font-semibold py-4 px-6 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl disabled:transform-none"
                    >
                      {isSubmitting ? (
